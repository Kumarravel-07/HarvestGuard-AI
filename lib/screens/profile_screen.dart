    ...
    if (user == null) {
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: const Text('Profile', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800)),
        ),
        body: const Center(
          child: Text(
          ...
          child: Column(
            ...
            children: [
                ...
                builder: (context, snapshot) {
                  ...
                  final name = storedName?.trim().isNotEmpty == true
                      ...
                      : (user.displayName?.trim().isNotEmpty == true
                            ...
                            : 'Name not available');
                  final email =
                      user.email ?? (data['email'] as String?) ?? 'Email not available';
                  ...
                  return Column(
                    children: [
                      ...
                      _ProfileActionButton(
                        ...
                        title: 'Edit Profile',
                        subtitle: 'Update your name, mobile number and language',
              ...
              _ProfileActionButton(
                ...
                title: 'About HarvestGuard AI',
                subtitle: 'Learn how the app helps farmers save produce',
                onTap: () => _showPlaceholder(context, 'HarvestGuard AI helps you track tomato freshness.'),
              ),
              const SizedBox(height: 12),
              _ProfileActionButton(
                icon: Icons.privacy_tip_outlined,
                title: 'Privacy Policy',
                subtitle: 'Read our data and privacy practices',
                onTap: () => _showPlaceholder(context, 'Privacy Policy is not available yet.'),
              ),
              const SizedBox(height: 12),
              _ProfileActionButton(
                ...
                onTap: () => _showPlaceholder(context, 'Support is coming soon.'),
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: const Text('Logout', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800)),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _InfoTile(
              title: 'Mobile Number',
              value: mobileNumber?.isNotEmpty == true ? mobileNumber! : 'Not available',
            ...
            _InfoTile(
              ...
              value: createdAt != null ? _formatDate(createdAt!) : 'Not available',
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListTile(
        ...
        trailing: Text(value, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w800)),
      ),
    );
  }
}
...
class _ProfileActionButton extends StatelessWidget {
  const _ProfileActionButton({required this.icon, required this.title, required this.subtitle, required this.onTap});
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Text(subtitle, style: const TextStyle(fontSize: 15, color: Colors.black54)),
