...
class PredictionHistoryRecord {
  ...
  factory PredictionHistoryRecord.fromFirestore(
    ...
    return PredictionHistoryRecord(
      createdAt: createdAt is Timestamp ? createdAt.toDate().toLocal() : DateTime.now(),
      ...
      recommendation: data['recommendation'] as String? ?? 'No recommendation available.',
      documentId: documentId,
      location: data['location'] as String?,
      temperature: data['temperature'] is num
          ? (data['temperature'] as num).toDouble()
          : null,
      humidity: data['humidity'] is num ? (data['humidity'] as num).toInt() : null,
    );
  }
